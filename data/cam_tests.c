...
static void open(const struct cli_cmd_entry *pEntry);
static void getframe(const struct cli_cmd_entry *pEntry);
static void set_clock(const struct cli_cmd_entry *pEntry);
